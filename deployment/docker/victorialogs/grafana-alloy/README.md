...
* alloy - logs collection agent configured to collect and write data to `vlagent`
...
* victoriametrics - metrics database, which collects metrics from `alloy` for observability purposes
