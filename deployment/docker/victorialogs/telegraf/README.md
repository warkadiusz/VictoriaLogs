...
* telegraf - logs collection agent configured to collect and write data to `vlagent`
...
* victoriametrics - metrics database, which collects metrics from `telegraf` for observability purposes
